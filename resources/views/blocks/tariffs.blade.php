<!-- tarrifs -->
<div class="block-tarrifs">
    <div class="wrapper">

        <div class="text-header-block">
            <h2>Getmancar carshering for our clients</h2>
        </div>
        <!-- Slider main container -->
        <div class="tarrifs__content-block swiper-tarrifs">
            ...
            <div class="swiper-button-next-tarrifs swiper-navigation-tarrifs"><a><img src="{{  asset('/images/content/icons/arrow-right.svg') }}"/></a> </div>
            <div class="swiper-button-prev-tarrifs swiper-navigation-tarrifs"> <a><img src="{{  asset('/images/content/icons/arrow-left.svg') }}"/></a></div>
        ...
        <div class="block-tarrifs__card">

            <x-tariff_card></x-tariff_card>
